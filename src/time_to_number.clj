...
(defn -main
  ...
  (init)
  (let [filter [:and
                [:time-interval ["field" 105 {:base-type "type/DateTime" :time-unit "s"}] :current :day]
                [:between ["field" 101 {:base-type "type/Integer"}] "2024-11-16" "2024-12-16"]
                [:between ["field" 101 {:base-type "type/Integer" :temporal-unit "minute"}] "2024-11-16T00:00:00" "2024-12-16T00:00:00"]
                ]
